...
<?php include 'layouts/head-main.php'; ?>
    ...
    <head>
        ...
        <title><?php echo $language["Lock_Screen"]; ?> | Symox - Admin & Dashboard Template</title>
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <form action="index.php">
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">Not you ? return <a href="auth-login.php" class="fw-medium text-primary"> Sign In </a></p>
                                        </div>
                                    </form>
                                </div>
